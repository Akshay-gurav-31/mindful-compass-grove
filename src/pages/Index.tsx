        ...
        <div className="mindful-container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center hover:shadow-md transition-shadow">
              <CardHeader>
                <div className="w-24 h-24 mx-auto rounded-full bg-mindful-blue mb-4"></div>
                <CardTitle>Shreyash Kumar</CardTitle>
                <CardDescription>Team Lead</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Leading our team with a passion for accessible mental healthcare solutions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Driving innovation in mental health technology and user experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Specialized in creating compassionate mental health support systems.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Focused on developing secure and effective mental health technologies.
                </p>
